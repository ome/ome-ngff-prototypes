...
def package_examples():
    ...
    for tp in timepoints:
        ...
        with zarr.N5Store(path1, mode="r") as f:
            d1 = f[key][:]
        with zarr.N5Store(path2, mode="r") as f:
            d2 = f[key][:]
        data.append(np.concatenate([d1[None], d2[None]], axis=0))
    ...
    metadata["volume"] = {"voxel_size": {"z": 1, "y": 0.65, "x": 0.65}, "unit": "micrometer"}
